...
print("Part 1: Min fuel {}, min value {}".format(*min_pos_consumption(positions, int)))
print("Part 2: Min fuel {}, min value {}".format(*min_pos_consumption(positions, cumulative_consumption)))
